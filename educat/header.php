                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 col-md-6 col-sm-5 hidden-xs">
                                    <span>Have any question? +91 9717877701, +91 9899615277, +91 8871661604   </span>
                                </div>
                                <div class="col-lg-5 col-md-6 col-sm-7 col-xs-12">
                                    ...
                                    <!--
                                        ...
                                        <div class="content"><a href="login/Institute-Sign-In.php"><i class="zmdi zmdi-sign-in"></i> Institute Login</a></div>
                                        <div class="content"><a href="login/Student-Sign-In.php"><i class="zmdi zmdi-sign-in"></i> Student Login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3 col-sm-12">
                                    <div class="logo">
                                        <a href="index.php">Vidyarthi Vigyan Manthan<!--<img src="img/logo/logo.png" alt="EDUCAT">--></a>
                                    </div>
                                </div>
                                        ...
                                        <div class="mainmenu">
                                            <nav>
                                                <ul id="nav">
                                                    ...
                                                    <li><a href="#">VVM in News</a></li>
                                                    <li><a href="#">Endorsement</a></li>
                                                    <li><a href="#">Gallery</a></li>
                                                    <li><a href="#">FAQ</a>
                                                        <ul class="sub-menu">
                                                            <li><a href="#">Frequenty Asked Questions</a></li>
                                                            <li><a href="#">Concerns & Queries</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">Contact</a>
                                                        <ul class="sub-menu">
                                                            <li><a href="#">VVM</a></li>
                                                            <li><a href="#">State Coordinators</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </nav>
