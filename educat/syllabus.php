                ...
                <div class="text-area pt-30 pb-50">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mt-20">
                                   <h4 style="color:#2d3e50"><b>THE SYLLABUS AND DISTRIBUTION OF MARKS:</b></h4><br>
						...
						<div class="course-duration">
                                        <div class="duration-title">
                                           <div class="text"><span>CONTENT</span> <span class="text-center">CONTRIBUTION</span> <span class="text-right">CURRICULUM</span></div>
                                        </div>
                                        <div class="duration-text">
                                            <div class="text"><span>Science and Mathematics from text books</span> <span class="text-center">40%
(40 Questions)
[2 Marks Each]</span> <span class="text-right">NCERT Curriculum
</span></div>
                                            <div class="text"><span>Indian Contribution to Science</span><span class="text-center">20%
(20 Questions)
[2 Marks Each]</span>  <span class="text-right">VVM Study Material*

</span></div>
                                            <div class="text"><span>Life stories of Dr. Homi Bhabha and Dr. Vikram Sarabhai	</span><span class="text-center">20%
(20 Questions)
[2 Marks Each]</span>  <span class="text-right">VVM Study Material*</span></div>
                                            <div class="text"><span>Logic, Reasoning & General Knowlege	</span> <span class="text-center">20%
(20 Questions)
[2 Marks Each]</span> <span class="text-right">General Reading
</span></div>
											
                                            <div class="text">*VVM Study Materials will be made available on www.vvm.org.in by 01 October 2017. No printed copies will be provided.
</span></div>
                                        </div>
                                    </div>
